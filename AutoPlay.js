...
goals.setGoal("autoUnicorn",1);
goals.setGoal("autoHunt",1);
goals.setGoal("autoPraise",1);
goals.setGoal("autoShatter",100);
goals.setGoal("tectonic",-1);
goals.setGoal("sunlifter",-1);
goals.res.thorium.autoCraftPerc = 25;
goals.res.eludium.autoCraftPerc = 25;
goals.res.kerosene.autoCraftPerc = 25;

goals.setType("religion",-1);
goals.setType("transcend",-1);

goals.setGoal("magneto",-1)
goals.setGoal("reactor",-1)
goals.setGoal("field",-1)
goals.setGoal("logHouse",-1)
goals.setGoal("hut",-1)
goals.setGoal("mansion",-1)
goals.setGoal("academy",-1)
goals.setGoal("mine",-1)
goals.setGoal("lumberMill",-1)
goals.setGoal("tradepost",-1)
goals.setGoal("temple",-1)
goals.setGoal("workshop",-1)
goals.setGoal("pasture",-1)
goals.setGoal("amphitheatre",-1)
goals.setGoal("aqueduct",-1)
